...
HANDLE Sec[2];
int x = 0, a = 1, b = 1;
int timeC[4] = { 23,58,58,7 };
int posX = 0, posY = 8 ;

void main()
{
	system("chcp 1251>null");
	printf("Это часы.\nПри нажатии на букву Q часы будут поставленны на паузу.\nПри нажатии на W программа завершит свою работу.\nПри нажатии на E можно настроить время.\nНа R секундомер.\nНа T таймер.\nДля начала работы нажмите любую кнопку.\n");
	int c = _getch();// Q-113(233) ENTER-13  W-119(246) E-101(243) R-114(234) T-116(229)
	Sleep(1000);
	Watch[1] = CreateThread(NULL, 0, Button, timeC, 0, 0);
	Watch[0] = CreateThread(NULL, 0, Delay, timeC, 0, 0);
	...
	if (p[3] == 7)
	{
		while (1)
		{
			...
			case 233:
				...
				{
					a = 1;
					ResumeThread(Watch[0]);
					InputChange(0, NULL);
				}
				else if (a == 1)
				{
					a = 0;
					SuspendThread(Watch[0]);
					InputChange(4, NULL);
				}
				break;
			case 119:
			case 246:
				TerminateThread(Watch[0], 0);
				ExitThread(0);
				break;
			case 101:
			case 243:
